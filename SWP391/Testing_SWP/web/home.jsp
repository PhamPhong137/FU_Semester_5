<%-- 
    Document   : home
    Created on : Jan 14, 2024, 11:46:20 PM
    Author     : Admin
--%>
            ...
            <div class="container-fluid .no-padding-margin">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8 navbar-list-option-mid">
                                <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active" href="home.jsp"><i class="fas fa-home"></i></a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link active" href="home.jsp"><i class="far fa-calendar-alt"></i></a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link active" href="home.jsp"><i class="fas fa-store"></i></a>
                                    </li>
                                    <li class="nav-item">
                ...
                <div class="col-lg-2 navbar-list-option-right">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="home.jsp"><i class="fas fa-bell"></i></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" href="login.jsp" id="link"><i
            ...
            <div class="row">
                ...
                <div class="col-lg-10 content-post" >
                    ...
                    <div class="calendar-embedded" >
                        <iframe src="calendar.jsp" frameborder="0"></iframe>
                    </div>
                </div>
            </div>
        </div>
