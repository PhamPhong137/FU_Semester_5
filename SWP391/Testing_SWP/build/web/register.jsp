<%-- 
    Document   : register
    Created on : Jan 14, 2024, 11:46:42 PM
    Author     : Admin
--%>
                    ...
                    <div class="col-lg-6 col-12 fxt-bg-color"  style="align-items: center;">
                        <div class="fxt-content">
                                ...
                                <form action="register" method="POST">
                                    <div class="name-input-style">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="firstname" class="form-control" name="firstname" placeholder="firstname" required="required">
                                        </div>
                                        <div class="form-group" style="margin-left: 20px;">
                                            <label for="name" class="input-label">Last Name</label>
                                            <input type="text" id="lastname" class="form-control" name="lastname" placeholder="lastname" required="required">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="number" class="form-control" name="phonenumber" placeholder="number" maxlength="10" minlength="10" required="required">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="re-password" type="password" class="form-control" name="cpassword" placeholder="********" required="required">
                            ...
                            <div class="fxt-footer">
                                <p>Have an account?<a href="login.jsp" class="switcher-text2 inline-text">Log in</a></p>
                            </div>
                        </div>
                    </div>
