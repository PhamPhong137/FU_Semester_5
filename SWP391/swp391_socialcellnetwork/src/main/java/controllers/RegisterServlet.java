...
public class RegisterServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if ((phone_number != null && !phone_number.isEmpty()) || (email != null && !email.isEmpty())) {
            if (!isUsernameExists && !isPhoneExists && !isEmailExists) {
                int userId = UserDAO.INSTANCE.addUser(f_name, l_name, gender, phone_number);
                try {
                    AccountDAO.INSTANCE.addAccount(userId, username, email, password, creation_date);
                ...
                if (isPhoneExists && phone_number != null && !phone_number.isEmpty()) {
                    request.setAttribute("errorPhone", "Phone number already exists!");
                }
                if (isEmailExists && email != null && !email.isEmpty()) {
