 ...
 * @author Admin
 */
public class OutFamilyServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet OutFamilyServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet OutFamilyServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean success = FamilyDAO.INSTANCE.outFamilyMember(familyId, currentUserId);
        int conversationId = ConversationDAO.INSTANCE.checkExistedFamilyConversation(familyId);
        ConversationDAO.INSTANCE.removeConversationMember(currentUserId, conversationId);
        if (success) {
